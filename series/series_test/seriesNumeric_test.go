...
func TestNewNumericSeries(t *testing.T) {
	t.Run("creates numeric series with index", func(t *testing.T) {
		values := []int{1, 2, 3}
		index := []string{"a", "b", "c"}
		ns := series.NewNumericSeries("test", values, index)
...
func TestAdd(t *testing.T) {
	t.Run("adds two integer series", func(t *testing.T) {
		values1 := []int{1, 2, 3}
		values2 := []int{4, 5, 6}
		ns1 := series.NewIndexNumericSeries("series1", values1)
		ns2 := series.NewIndexNumericSeries("series2", values2)
	...
	t.Run("uses default name when empty string provided", func(t *testing.T) {
		values1 := []int{1, 2, 3}
		values2 := []int{4, 5, 6}
		ns1 := series.NewIndexNumericSeries("s1", values1)
		ns2 := series.NewIndexNumericSeries("s2", values2)
...
func TestPow(t *testing.T) {
	...
	t.Run("uses default name when empty string provided", func(t *testing.T) {
		values := []int{2, 3, 4}
		ns := series.NewIndexNumericSeries("mytest", values)
